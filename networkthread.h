...
class NetworkThread
{
    ...
    int i; // an identifier
    NetworkThread* other; // a reference to the "other" thread in this example
...
public:
    ...
    */
    NetworkThread(int i, NetworkThread* other, std::mutex* _mutex, std::condition_variable* _condition_variable);
