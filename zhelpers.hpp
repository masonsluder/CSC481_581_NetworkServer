/**
* This helper header file was taken from the ZMQ ZGuide GitHub repository to add additional functions
* to assist with the construction of networks: https://github.com/booksbyus/zguide/blob/master/examples/C%2B%2B/zhelpers.hpp
*/
